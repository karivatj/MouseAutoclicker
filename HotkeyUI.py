...
class Ui_HotKey(object):
    def setupUi(self, HotKey):
        ...
        self.lblKey.setText(_fromUtf8(""))
        self.lblKey.setPixmap(QtGui.QPixmap(_fromUtf8(":/images/shift_inactive.png")))
        ...
        self.label = QtGui.QLabel(HotKey)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, HotKey):
        ...
        self.label.setText(_translate("HotKey", "Y", None))
